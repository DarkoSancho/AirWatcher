...
// Nouvelle mÃ©thode de calcul pour score de similaritÃ© donnée par Yassine 
...
// code de Yassine sans le "const auto" ( le const auto marche pas dans ma version de C++)
...
// j'ai ajouté des seuils par défaut 
