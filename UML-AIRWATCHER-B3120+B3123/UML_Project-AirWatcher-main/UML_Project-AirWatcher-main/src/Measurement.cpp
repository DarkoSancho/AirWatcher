...
void Measurement::setTimestamp(time_t timestamp)
{
...
Measurement::Measurement(const time_t timestamp, const string sensorId, const string attributeId, const float value)
