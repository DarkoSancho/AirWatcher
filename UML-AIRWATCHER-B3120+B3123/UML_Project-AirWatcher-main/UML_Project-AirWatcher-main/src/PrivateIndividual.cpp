...
PrivateIndividual::PrivateIndividual(const string accountID, const int privilege, const list<string>& sensorID, float points)
    : Account(accountID, privilege), sensorID(sensorID), points(points)
{
}
